...
I recently attended a lot of talks by scientists from all over, from FANG companies, and this is my thought and take on current AI systems and how their future looks like. And how we should go along with this fast paced AI race. I myself am a student and am constantly adapting to this everyday changing field, and this is my take on it. Here, I also refrain from using some complex terms like awareness, consciousness, etc., whose meanings I do not know clearly.
...
A lot of my understanding comes from a talk by Prof. Srinath Sridhar at IISER Pune recently. I personally found his work very inspiring, please find more at [link](https://ivl.cs.brown.edu/).
...
There are a lot of companies currently trying to make AI open-source in the hope of democratizing it and making it more personalized by every indiviual's data. But what if we do not have any of our own data? Generating data like text and art from our own creativity is still useful even for upcoming AI systems to be personalized. We should use AI like calculators, not while learning multiplication, but when we have learned it and are building upon it. And, we should keep generating new data for even AI for it to be helpfull for us.
